    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Yönetici'), ('manager', 'Müdür'), ('trainer', 'Eğitmen'), ('receptionist', 'Resepsiyon'), ('member', 'Üye')], default='member', max_length=20, verbose_name='Rol')),
